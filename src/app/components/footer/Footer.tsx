    ...
    <div className={styles.container}>
      <div className={styles.info}>
        ...
        <div className={styles.icons}>
          <Image src={facebook} alt="" width={18} height={18} />
          <Image src={instagram} alt="" width={18} height={18} />
          <Image src={tiktok} alt="" width={18} height={18} />
          <Image src={youtube} alt="" width={18} height={18} />
        </div>
      </div>
